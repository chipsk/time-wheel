package com.chipsk.timer.zset;


import com.chipsk.jedis.JedisUtil;
import com.chipsk.jedis.SerializeUtils;
import com.chipsk.timer.AbstractTimer;
import com.chipsk.timer.ExceptionHandler;
import com.chipsk.timer.Executor;
...
public class ZSetTimer extends AbstractTimer {
    ...
    private class Worker implements Runnable {
         ...
         * 会在exec时正好被拿出来执行，后者尚未到执行时刻，所以均对程序无影响
         *
         * @return 探测到的到期任务
         */
